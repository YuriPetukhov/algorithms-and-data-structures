package hw17_dijkstra_algorithm.visualization;

import hw17_dijkstra_algorithm.libs.graphs.Edge;

public final class ShortestPathConsoleVisualizer {
    private ShortestPathConsoleVisualizer() {
    }
    ...
    public static void pathEdges(Edge[] edges) {
        if (edges.length == 0) {
            System.out.println("[]");
            return;
        }
