...
import hw17_dijkstra_algorithm.service.steps.shortestpath.BellmanFordStep;
...
public class BellmanFordDemo {
    public static void main(String[] args) {
        ...
        ShortestPathConsoleVisualizer.title("Bellman-Ford shortest path from " + start + " to " + target);
