...
import hw02_dynamic_programming_and_testing.app.solver.FibMatrixSolver;
import hw02_dynamic_programming_and_testing.app.core.Solver;

import java.math.BigInteger;

public class FibMatrixTask implements MeasurableTask<Integer, BigInteger> {

    private final Solver<Integer, BigInteger> solver = new FibMatrixSolver();
    ...
    public String displayName() {
        return "Фибоначчи: умножение матриц O(LogN)";
    }
