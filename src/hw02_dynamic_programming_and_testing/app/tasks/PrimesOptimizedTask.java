...
import hw02_dynamic_programming_and_testing.app.solver.PrimesOptimizedSolver;

public class PrimesOptimizedTask implements MeasurableTask<Integer, Integer> {

    private final Solver<Integer, Integer> solver = new PrimesOptimizedSolver();

    @Override public String id() { return "primes_optimized_count"; }

    @Override
    public String displayName() {
        return "Простые числа: деление на найденные простые";
    }
