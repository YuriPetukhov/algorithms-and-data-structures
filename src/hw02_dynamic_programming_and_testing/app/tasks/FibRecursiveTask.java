...
import hw02_dynamic_programming_and_testing.app.solver.FibRecursiveSolver;
import hw02_dynamic_programming_and_testing.app.core.Solver;

import java.math.BigInteger;

public class FibRecursiveTask implements MeasurableTask<Integer, BigInteger> {

    private final Solver<Integer, BigInteger> solver = new FibRecursiveSolver();
    ...
    public String displayName() {
        return "Фибоначчи: рекурсивный O(2^N)";
    }
